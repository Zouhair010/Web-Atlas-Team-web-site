...
function ContactInfo({lang}){
  return (
    <div className="lg:col-span-5 flex flex-col justify-between">
              ...
              whiteSpace: "nowrap"
            }} className="text-[11px] font-['JetBrains_Mono'] tracking-widest text-b
            lue-300 bg-blue-500/5 px-2.5 py-1 rounded border border-blue-500/10">{data["contactInfoContent"][lang]["badge"]}</span>
                <h2 className="font-['Cairo'] text-2xl sm:text-3xl md:text-4xl font-black mt-5 mb-4 text-white leading-snug">{data["contactInfoContent"][lang]["title"]}</h2>
